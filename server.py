...
from crossvals.naschain.naschain import NaschainCrossVal
...
@app.post("/naschain", tags=["Mainnet"])
def naschain():
    return naschain_crossval.run()
...
naschain_crossval = NaschainCrossVal(subtensor=subtensor)