...
@app.get("/")
def read_root():
    return "Hello, greetings from comtensor team 👋"
...
#     print(item)
#     return await wombo_crossval.run(
#         ImageGenerationClientInputs(prompt=item.prompt, watermark=item.watermark)
#     )
...
#     return transcription_crossval.run(
#         {
#             "type": item.type,
#             "audio_url": item.audio_url,
#             "audio_sample": item.audio_sample,
#         }
#     )
